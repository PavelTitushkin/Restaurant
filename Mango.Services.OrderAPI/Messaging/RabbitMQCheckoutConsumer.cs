...
namespace Mango.Services.OrderAPI.Messaging
{
    public class RabbitMQCheckoutConsumer : BackgroundService
    {
        ...
        public RabbitMQCheckoutConsumer(OrderRepository orderRepository, IRabbitMqServiceProducer rabbitMqService)
        {
        ...
        private async Task HandleMessage(CheckoutHeaderDto checkoutHeaderDto)
        {
            ...
            try
            {
                _rabbitMqService.PublishMessageAsync(paymentRequestMessage, "orderpaymentprocesstopic");
            }
            catch (Exception e)
            {
                throw;
